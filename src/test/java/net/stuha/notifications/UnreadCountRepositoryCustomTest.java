...
public class UnreadCountRepositoryCustomTest extends AbstractTest {
    ...
    @Test
    public void readAllUnreadCounts() {
        List<Conversation> unreadCounts = unreadCountRepositoryCustom.readAllUnreadCounts(UUID.fromString("00000000-0000-f3e5-c5ed-000000000017"));
